...
export const base = {rootscrolllock,rootcolor,rootscrollgutter,svg,scrollbar,properties};
export const components = {stat,tooltip,indicator,menu,filter,validator,stack,hero,kbd,checkbox,fileinput,divider,calendar,mockup,button,breadcrumbs,textarea,dropdown,skeleton,rating,card,modal,radialprogress,fab,navbar,label,toggle,progress,select,diff,collapse,status,list,toast,carousel,hovergallery,steps,range,link,timeline,countdown,table,textrotate,badge,footer,loading,radio,hover3d,mask,input,drawer,tab,dock,avatar,chat,alert,fieldset,swap};
